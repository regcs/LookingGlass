...
print("executing subprocess: ", sys.argv, any("subprocess" in s for s in sys.argv))
if len(sys.argv) > 1 and any("subprocess" in s for s in sys.argv):
    print(subprocess.check_output(['python', '/Users/christian/github/LoneTech_mod/freeHoloPlayCore.py']))
